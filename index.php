...
<meta name="keywords" content="move, nem, billig">
    ...
    <body>
        ...
        <div class="section no-pad-bot" id="home">
            <div class="container">
                ...
                <div class="row center">
                    <img class="responsive-img" src="img/logo_cirkel.png" alt="GoMove billig og nem flytning" width="40%">
                </div>
                <div class="row center">
                ...
                <div class="row">
                    <div class="col s12 m4">
                        <div class="icon-block">
                            <img class="responsive-img" src="img/om-grafik-18.png" alt="GoMove er en tjeneste hvor du har mulighed for at søge hjælp til flytning eller tilbyde hjælp">
                    ...
                    <div class="col s12 m4">
                        <div class="icon-block">
                            <img class="responsive-img" src="img/om-grafik-19.png" alt="Er dine venner også træt af at bære kasser ned for 4. sal, mangler du penge til weekendens bytur - Hos GoMove hjælper vi hinanden nemt og billigt">
                    ...
                    <div class="col s12 m4">
                        <div class="icon-block">
                            <img class="responsive-img" src="img/om-grafik-20.png" alt="Opret dig som bruger og flyt elelr hjælp allerede i dag">
